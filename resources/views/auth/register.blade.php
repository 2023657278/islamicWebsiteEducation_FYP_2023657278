            ...
            <div class="rainbow-card-wrapper">
                <div class="card p-4">
                    <div class="card-title text-center mb-4">
                        <h2 class="fw-bold text-success mb-2">{{ __('Create Account') }}</h2>
                        <p class="text-muted small">Join our community in just a few simple steps.</p>
                    </div>
                    ...
                    <div class="card-body p-0">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <div class="form-text text-muted small px-2 mt-1">
                            ...
                            <div class="d-grid mb-2">
                                <button type="submit" class="btn btn-success btn-lg font-weight-bold text-white shadow-sm" style="border-radius: 10px;">
                                    {{ __('Register') }}
                                </button>
                            </div>
                        </form>
