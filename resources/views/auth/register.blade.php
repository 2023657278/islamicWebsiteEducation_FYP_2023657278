                ...
                <div class="card p-4">
                    ...
                    <div class="card-body p-0">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <!-- 🟢 ALL INPUTS CHANGED TO 68px HEIGHT WITH EXPANDED PADDING & FONT -->
                            <div class="form-floating mb-3">
                                ...
                                <label for="name" style="color: #64748b; padding-left: 16px; top: 2px;">
                            ...
                            <div class="form-floating mb-3">
                                <input id="no_maktab" type="text" class="form-control @error('no_maktab') is-invalid @enderror" 
                                    ...
                                    style="border-radius: 14px; padding-top: 1.8rem !important; padding-bottom: 0.7rem !important; padding-left: 16px; border: 1px solid #cbd5e1; background-color: #f8fafc; font-size: 1.15rem; font-weight: 500; height: 68px !important;">
                                <label for="no_maktab" style="color: #64748b; padding-left: 16px; top: 2px;">
                            ...
                            <div class="form-floating mb-3">
                                <input id="phone_number" type="text" class="form-control @error('phone_number') is-invalid @enderror" 
                                    ...
                                    style="border-radius: 14px; padding-top: 1.8rem !important; padding-bottom: 0.7rem !important; padding-left: 16px; border: 1px solid #cbd5e1; background-color: #f8fafc; font-size: 1.15rem; font-weight: 500; height: 68px !important;">
                                <label for="phone_number" style="color: #64748b; padding-left: 16px; top: 2px;">
                            ...
                            <div class="form-floating mb-3">
                                <input id="password-confirm" type="password" class="form-control" 
                                    ...
                                    style="border-radius: 14px; padding-top: 1.8rem !important; padding-bottom: 0.7rem !important; padding-left: 16px; border: 1px solid #cbd5e1; background-color: #f8fafc; font-size: 1.15rem; height: 68px !important;">
                                <label for="password-confirm" style="color: #64748b; padding-left: 16px; top: 2px;">
                            ...
                            <div class="d-grid mb-2">
                                <button type="submit" class="btn btn-success btn-lg font-weight-bold text-white shadow-sm py-3" 
                                    style="border-radius: 12px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); border: none; font-size: 1.05rem;">
