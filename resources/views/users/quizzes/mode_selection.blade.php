...
<div class="container py-5">
    <div class="text-center mb-5">
        ...
        <p class="text-muted">Subject: <span class="badge bg-primary px-3">{{ $subject->subject_name }}</span></p>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 rounded-4 shadow-lg" style="background: #0f172a;">
            ...
            <div class="modal-body p-4">
                <a href="{{ route('student.quizzes.browse', $subject->id) }}" class="btn btn-outline-info w-100 rounded-pill mb-3 fw-bold">
                ...
                <a href="{{ route('student.quizzes.difficulties', $subject->id) }}?mode=pvp" class="btn btn-primary w-100 rounded-pill fw-bold">
