...
<head>
    ...
    <title>Select Mission | {{ $subject->subject_name }}</title>
...
<div class="back-nav-container">
    <a href="{{ route('student.quizzes.index') }}" class="btn btn-back text-decoration-none d-inline-flex align-items-center">
...
<div class="container py-5">
    <div class="text-center mb-5">
        ...
        <p class="text-white-50">Subject: <span class="badge badge-subject px-3 py-2 fs-6 rounded-3 shadow-sm">{{ $subject->subject_name }}</span></p>
    </div>

    <div class="row g-4 justify-content-center">
        <div class="col-md-5">
            <a href="{{ route('student.quizzes.difficulties', $subject->id) }}?mode=solo" class="text-decoration-none">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 rounded-4 shadow-lg" style="background: #0f172a;">
            ...
            <div class="modal-body p-4">
                <a href="{{ route('student.quizzes.browse', $subject->id) }}" class="btn btn-outline-info w-100 rounded-pill mb-3 fw-bold py-2">
                    <i class="fas fa-search me-2"></i>FIND PUBLIC LOBBY
                </a>

                <form action="{{ route('student.quizzes.join') }}" method="POST" class="mb-4">
                    @csrf
                ...
                <a href="{{ route('student.quizzes.difficulties', $subject->id) }}?mode=pvp" class="btn btn-primary w-100 rounded-pill fw-bold py-2 text-white border-0" style="background: #3b82f6;">
