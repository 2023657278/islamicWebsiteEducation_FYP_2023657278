...
<head>
    ...
    <title>Student Portal | Ilmora PAI</title>
...
<body class="{{ Route::is('student.homepage') ? 'is-homepage' : '' }}">
    ...
    <div class="sidebar">
        ...
        <nav class="nav flex-column mb-auto">
            <!-- Home Portal -->
            <a class="nav-link {{ Route::is('student.homepage') ? 'active' : '' }}" 
               href="{{ route('student.homepage') }}"
               style="{{ Route::is('student.homepage') ? 'margin-bottom: 20px; border: 1px solid rgba(212, 175, 55, 0.3); background: rgba(212, 175, 55, 0.1);' : 'margin-bottom: 20px;' }}">
            ...
            <a class="nav-link {{ Route::is('student.quizzes.index') ? 'active' : '' }}" href="{{ route('student.quizzes.index') }}">
                <i class="fas fa-tasks"></i> <span>Quizzes</span>
            </a>
            <a class="nav-link {{ Route::is('student.textbooks.index') ? 'active' : '' }}" href="{{ route('student.textbooks.index') }}">
                <i class="fas fa-book-reader"></i> <span>Textbooks</span>
            </a>
            <a class="nav-link {{ Route::is('student.ranking') ? 'active' : '' }}" href="{{ route('student.ranking') }}">
            ...
            <a href="{{ route('student.profile.show') }}" class="text-decoration-none">
                <div class="avatar-capsule shadow-sm">
                    ...
                    <div class="text-start">
                        <div style="font-weight: 800; font-size: 0.8rem; color: #1A202C; line-height: 1;">{{ explode(' ', Auth::user()->name)[0] }}</div>
                    </div>
                </div>
            </a>
        </div>
