...
<style>
    ...
    .avatar-box { width: 200px; height: 200px; background: white; padding: 6px; border-radius: 20px; position: absolute; top: -30px; left: 40px; box-shadow: 0 4px 6px rgba(0,0,0,0.05); }
