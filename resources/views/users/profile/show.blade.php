...
<style>
    ...
    .avatar-box { width: 200px; height: 200px; background: white; padding: 6px; border-radius: 20px; position: absolute; top: -100px; left: 40px; box-shadow: 0 4px 6px rgba(0,0,0,0.05); }
...
<div class="container-fluid text-start">
    ...
    <div class="profile-card shadow-sm">
        ...
        <div class="profile-content">
            ...
            <div class="d-flex justify-content-between align-items-end pt-3" style="padding-left: 220px;">
                <div>
