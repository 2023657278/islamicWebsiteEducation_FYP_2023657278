...
return new class extends Migration
{
    ...
    public function up()
    {
        // 1. CREATE BOOKMARKS (For Students to save notes)
        ...
        // 2. EXAM PAPERS (The Past Year Paper Title)
        ...
        // 3. EXAM QUESTIONS (Linked to the Paper)
        ...
        // 4. EXAM RESULTS (Student Score History)
