...
<div class="container-fluid p-4 pb-5 text-start" style="min-height: 100vh;">
    ...
    <div class="mb-4 d-flex justify-content-between align-items-center">
        ...
        <a href="<?php echo e(route('student.dashboard')); ?>" class="btn btn-light border rounded-pill px-4 fw-bold shadow-sm">
    ...
    <div class="row g-4 mb-5">
        <div class="col-xl-3 col-md-6">
            <div class="card border-0 shadow-sm rounded-4 text-white h-100 hover-scale" style="background: linear-gradient(135deg, #00C853, #64DD17);">
                <div class="card-body p-4 text-white">
                    ...
                    <h1 class="fw-bold mb-0 text-white"><?php echo e(round($currentAvg, 1)); ?>%</h1>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card border-0 shadow-sm rounded-4 text-white h-100 hover-scale" style="background: linear-gradient(135deg, #2962FF, #448AFF);">
                <div class="card-body p-4 text-white">
                    ...
                    <h1 class="fw-bold mb-0 text-white"><?php echo e($predictedNextScore); ?>%</h1>
                    <small class="opacity-75">Slope Index: <?php echo e($slope); ?></small>
                </div>
            </div>
        </div>
        <?php
        ...
        ?>
        <div class="col-xl-3 col-md-6">
            <div class="card border-0 shadow-sm rounded-4 text-white h-100 hover-scale" style="background: <?php echo e($statusColor); ?>;">
                <div class="card-body p-4 text-white">
                    <h5 class="opacity-75 mb-1 text-white">Growth Status</h5>
                    <h3 class="fw-bold mb-0 text-white"><?php echo e($status); ?></h3>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card border-0 shadow-sm rounded-4 text-white h-100 hover-scale" style="background: #455A64;">
                <div class="card-body p-4 text-white">
                    ...
                    <h1 class="fw-bold mb-0 text-white"><?php echo e($totalQuizzes); ?></h1>
    ...
    <div class="row g-4 mb-5">
        <?php $__currentLoopData = $subjectProgress; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col-md-4">
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-body p-4 position-relative">
                    <span class="badge rounded-pill position-absolute top-0 end-0 mt-3 me-3 px-3 py-2 text-white" style="background-color: <?php echo e($sub->color); ?>;">
                        <?php echo e($sub->rank); ?>

                    </span>
                    <h5 class="fw-bold mb-4"><?php echo e($sub->name); ?></h5>
                    <div class="row align-items-center">
                        <div class="col-5">
                            <div style="height: 100px; position: relative;">
                                <canvas id="chart-<?php echo e($index); ?>"></canvas>
                                <div class="position-absolute top-50 start-50 translate-middle fw-bold small"><?php echo e($sub->avg_score); ?>%</div>
                            </div>
                        </div>
                        <div class="col-7 ps-0">
                            ...
                            <div class="d-flex justify-content-between align-items-center bg-light rounded p-2 border">
                                ...
                                <i class="fas <?php echo e($sub->avg_score >= 40 ? 'fa-unlock text-primary' : 'fa-lock text-muted opacity-50'); ?>"></i>
                                <div style="width: 10px; height: 1px; background: #ccc;"></div>
                                <i class="fas <?php echo e($sub->avg_score >= 80 ? 'fa-unlock text-danger' : 'fa-lock text-muted opacity-50'); ?>"></i>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="card border-0 shadow-sm rounded-4" id="logTableSection">
        <div class="card-body p-4">
            ...
            <form id="filterForm" action="<?php echo e(route('student.progress.index')); ?>" method="GET" class="row g-2 mb-4 align-items-center">
                <div class="col-md-5">
                    <div class="input-group">
                        <span class="input-group-text bg-white border-end-0"><i class="fas fa-search text-muted"></i></span>
                        <input type="text" name="search" class="form-control border-start-0 filter-input" placeholder="Search quiz title..." value="<?php echo e(request('search')); ?>">
                    </div>
                </div>
                <div class="col-md-2">
                    <select name="result_status" class="form-select filter-input">
                        <option value="">All Status</option>
                        <option value="pass" <?php echo e(request('result_status') == 'pass' ? 'selected' : ''); ?>>Passed</option>
                        <option value="fail" <?php echo e(request('result_status') == 'fail' ? 'selected' : ''); ?>>Failed</option>
                    </select>
                </div>
                <div class="col-md-2">
                    <select name="subject_filter" class="form-select filter-input">
                        <option value="all">All Subjects</option>
                        <?php $__currentLoopData = $filterSubjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($sub); ?>" <?php echo e(request('subject_filter') == $sub ? 'selected' : ''); ?>><?php echo e($sub); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="col-md-3">
                    <input type="date" name="filter_date" class="form-control filter-input" value="<?php echo e(request('filter_date')); ?>">
                </div>
            </form>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="ps-3 text-muted"><?php echo e(\Carbon\Carbon::parse($attempt->created_at)->format('d M Y')); ?></td>
                            <td><span class="badge bg-light text-dark border px-2 py-1"><?php echo e($attempt->subject_name); ?></span></td>
                            <td class="fw-bold text-start text-dark"><?php echo e($attempt->quiz_title); ?></td>
                            <td><span class="fw-bold <?php echo e($attempt->score >= 50 ? 'text-success' : 'text-danger'); ?>"><?php echo e($attempt->score); ?>%</span></td>
                            <td>
                                <?php if($attempt->score >= 50): ?>
...
<script>
    ...
    <?php echo json_encode($subjectProgress, 15, 512) ?>.forEach((sub, index) => {
    ...
    const slope = <?php echo e($slope); ?>;
    const predicted = <?php echo e($predictedNextScore); ?>;
...
<?php echo $__env->make('users.students', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\islamicWebsiteEducation_FYP_2023657278\resources\views/users/progress/index.blade.php ENDPATH**/ ?>