...
<div class="container-fluid p-0 text-start position-relative">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="badge bg-dark rounded-pill px-3 py-2 fs-6 shadow-sm">
            <i class="fas fa-users me-2 text-info"></i>Pool: <?php echo e($rankings->count()); ?> Users
        </div>
    </div>
    ...
    <div class="rank-card shadow-sm bg-white">
        <table class="table mb-0">
            ...
            <tbody>
                ...
                <?php $__currentLoopData = $rankings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $rUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <?php if($isRanked): ?>
                        <tr class="<?php echo e($isMe ? 'row-highlight-me' : ''); ?>">
                            <td class="ps-4">
                                <div class="rank-number <?php echo e($posClass); ?>"><?php echo e($displayRank); ?></div>
                            </td>
                            <td>
                                <div class="d-flex align-items-center gap-3">
                                    <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($rUser->name)); ?>&background=<?php echo e($isMe ? '10b981' : '64748b'); ?>&color=fff&bold=true" class="rounded-circle shadow-sm" width="38" height="38">
                                    <div>
                                        <span class="fw-bold <?php echo e($isMe ? 'text-success fs-5' : 'text-dark'); ?>"><?php echo e($rUser->name); ?></span>
                                        <?php if($isMe): ?>
                            ...
                            <td>
                                <span class="tier-badge <?php echo e($tierClass); ?>">
                                    <i class="fas fa-shield-alt"></i> <?php echo e($rankName); ?>

                                </span>
                            </td>
                            <td class="text-end pe-4">
                                <span class="fw-black fs-5 <?php echo e($isMe ? 'text-success' : 'text-primary'); ?>"><?php echo e(number_format($rUser->pvp_points)); ?></span>
    ...
    <?php if($currentUserData): ?>
        ...
        <div class="user-sticky-hud d-flex justify-content-between align-items-center animate__animated animate__fadeInUp">
            <div class="d-flex align-items-center gap-3">
                <?php if($isUnrankedPastMax): ?>
                    <div class="rank-number tier-unranked px-3 w-auto h-auto py-2 small" style="font-size:0.75rem;">UNRANKED</div>
                <?php else: ?>
                    <div class="rank-number <?php echo e(($myRankPosition <= 3) ? 'top-'.$myRankPosition : ''); ?> shadow-sm" style="width: 42px; height: 42px; font-size:1.1rem;">
                        #<?php echo e($myRankPosition); ?>

                    </div>
                <?php endif; ?>
                <div>
                    <small class="text-white-50 d-block tracking-wider text-uppercase" style="font-size:0.65rem;">Your Standings Status</small>
                    <h5 class="fw-bold text-white mb-0"><?php echo e($currentUserData->name); ?> <span class="text-success small ms-1">(Online)</span></h5>
                </div>
            </div>
            ...
            <div class="d-flex align-items-center gap-4">
                <div class="text-center">
                    ...
                    <span class="tier-badge <?php echo e($myTierClass); ?> px-3 py-1 shadow-sm">
                        <i class="fas fa-shield-alt"></i> <?php echo e($myTierName); ?>
                ...
                <div class="text-end border-start border-secondary ps-4">
                    ...
                    <span class="fw-black text-warning fs-3"><?php echo e(number_format($currentUserData->pvp_points)); ?></span>
...
<?php echo $__env->make('users.students', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\islamicWebsiteEducation_FYP_2023657278\resources\views/users/ranking.blade.php ENDPATH**/ ?>