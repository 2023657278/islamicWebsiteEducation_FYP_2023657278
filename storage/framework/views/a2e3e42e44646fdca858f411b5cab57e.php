        ...
        <table class="table mb-0">
            ...
            <tbody>
                <?php $__currentLoopData = $rankings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $rUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        <td>
                            <div class="rank-number <?php echo e($posClass); ?>"><?php echo e($index + 1); ?></div>
                        </td>
                        <td>
                            <div class="d-flex align-items-center gap-3">
                                <div class="fw-bold text-dark"><?php echo e($rUser->name); ?></div>
                                <?php if($rUser->id === Auth::id()): ?>
                                    <span class="badge bg-primary rounded-pill" style="font-size: 0.6rem;">YOU</span>
                                <?php endif; ?>
                            </div>
                        </td>
                        <td>
                            <span class="tier-badge <?php echo e($class); ?>">
                                <i class="fas fa-shield-alt me-1"></i> <?php echo e($rankName); ?>

                            </span>
                        </td>
                        <td class="text-end">
                            <span class="fw-black fs-5 text-primary"><?php echo e(number_format($rUser->pvp_points)); ?></span>
