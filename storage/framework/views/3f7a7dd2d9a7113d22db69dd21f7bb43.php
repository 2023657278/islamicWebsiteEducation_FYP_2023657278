...
<body>
    ...
    <div class="sidebar">
        ...
        <nav class="nav flex-column mb-auto">
            <a class="nav-link <?php echo e(Route::is('student.homepage') ? 'active' : ''); ?>" href="<?php echo e(route('student.homepage')); ?>"><i class="fas fa-home"></i> Homepage</a>
        ...
        <div class="topbar">
            ...
            <div class="profile-section">
                ...
                <div class="text-end d-none d-md-block">
                    <div style="font-weight: 700; font-size: 0.9rem;"><?php echo e(Auth::user()->name); ?></div>
                ...
                <a href="<?php echo e(route('student.profile.show')); ?>" class="text-decoration-none">
                    <div class="avatar">
                        <?php if(Auth::user()->profile_image): ?>
                            ...
                            <img src="<?php echo e(asset('storage/' . Auth::user()->profile_image)); ?>" alt="User" style="width: 100%; height: 100%; object-fit: cover;">
                        <?php else: ?>
