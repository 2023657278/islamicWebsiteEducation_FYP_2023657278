...
<div class="container-fluid p-0 text-start">
    ...
    <ul class="nav nav-pills mb-4 gap-2" id="pills-tab" role="tablist">
        ...
        <?php $isLocked = !in_array($level, $allowed); ?>
        <li class="nav-item" role="presentation">
            <button class="nav-link rounded-pill px-4 <?php echo e($loop->first ? 'active' : ''); ?> 
                    <?php echo e($level == 'Easy' ? 'btn-outline-success' : ($level == 'Medium' ? 'btn-outline-warning' : 'btn-outline-danger')); ?>

                    <?php echo e($isLocked ? 'disabled opacity-50' : ''); ?>" 
                    id="pills-<?php echo e($level); ?>-tab" 
                    data-bs-toggle="pill" 
                    data-bs-target="#pills-<?php echo e($level); ?>" 
                    type="button" 
                    role="tab">
                <?php if($isLocked): ?> <i class="fas fa-lock me-1"></i> <?php endif; ?>
                <?php echo e($level); ?>
        ...
        <div class="tab-pane fade <?php echo e($loop->first ? 'show active' : ''); ?>" id="pills-<?php echo e($level); ?>" role="tabpanel">
            <?php if($isLocked): ?>
                <div class="text-center py-5 bg-white rounded-4 shadow-sm border">
                    <div class="mb-3 text-muted"><i class="fas fa-lock fa-4x"></i></div>
                    <h4 class="fw-bold">Level Locked</h4>
                    <p class="text-danger fw-bold"><?php echo e($requirements[$level]['reason']); ?></p>
                </div>
            <?php else: ?>
                <div class="row g-4">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden position-relative">
                                ...
                                <div class="card-body p-4 d-flex flex-column">
                                    ...
                                    <p class="text-muted small mb-4"><?php echo e(Str::limit($quiz->description, 60)); ?></p>
                                    ...
                                    <div class="mt-auto">
                                        <?php if($quiz->is_completed): ?>
                                            ...
                                            <a href="<?php echo e(route('student.quizzes.show', $quiz->id)); ?>" class="btn btn-outline-dark w-100 rounded-pill">Retake</a>
                                        <?php else: ?>
                                            <a href="<?php echo e(route('student.quizzes.show', $quiz->id)); ?>" class="btn btn-primary w-100 rounded-pill shadow-sm">Start Quiz</a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                    ...
                    <?php else: ?>
                        <div class="col-12 text-center py-5">
                            <p class="text-muted">No <?php echo e($level); ?> quizzes available here.</p>
                        </div>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
