...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo e(route('quizzes.create')); ?>" class="btn px-4 py-2" style="background:var(--maroon); color:white; border-radius:10px; font-weight: 600;">
    ...
    <div class="bg-white p-3 rounded-lg shadow-sm mb-4 d-flex gap-3 align-items-center">
        ...
        <select id="subjectFilter" class="form-control w-auto">
            ...
            <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($s->subject_name); ?>"><?php echo e($s->subject_name); ?></option>
    ...
    <div class="quiz-grid" id="quizContainer">
        ...
        <div class="quiz-item" 
             data-title="<?php echo e(strtolower($quiz->title)); ?>" 
             data-topic="<?php echo e(strtolower($quiz->topic)); ?>" 
             data-subject="<?php echo e($quiz->subject->subject_name); ?>" 
             data-difficulty="<?php echo e($quiz->difficulty); ?>">
            <div class="quiz-card">
                <span class="difficulty-badge diff-<?php echo e(strtolower($quiz->difficulty)); ?>">
                    <?php echo e($quiz->difficulty); ?>

                </span>

                <div class="mb-2">
                    <h4 class="font-weight-bold mb-1" style="color: #2d3748; padding-right: 80px;"><?php echo e($quiz->title); ?></h4>
                    <p class="text-muted small mb-3"><?php echo e(Str::limit($quiz->description, 60)); ?></p>
                </div>

                <div class="mb-4">
                    <span class="subject-pill"><?php echo e($quiz->subject->subject_name); ?></span>
                    <span class="text-muted small ml-2"><?php echo e($quiz->topic); ?></span>
                </div>

                <div class="stats-row">
                    <div class="stat-item">
                        <h4><?php echo e($quiz->questions->count()); ?></h4>
                        <span>Questions</span>
                    </div>
                    <div class="stat-item">
                        <h4><?php echo e($quiz->duration_minutes); ?>m</h4>
                        <span>Duration</span>
                    </div>
                </div>
                ...
                <div class="mt-auto d-flex gap-2">
                    <a href="<?php echo e(route('quizzes.manage', $quiz->id)); ?>" class="btn btn-sm btn-light flex-grow-1 border" style="background: #ebf8ff; color: #3182ce; border: none !important;"><i class="fas fa-chart-bar mr-1"></i> Manage</a>
                    <a href="<?php echo e(route('quizzes.edit', $quiz->id)); ?>" class="btn btn-sm btn-light flex-grow-1 border" style="background: #fffbe6; color: #d4a017; border: none !important;"><i class="fas fa-edit mr-1"></i> Edit</a>
                    <form action="<?php echo e(route('quizzes.destroy', $quiz->id)); ?>" method="POST">
...
<?php echo $__env->make('admin.adminhome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\islamicWebsiteEducation_FYP_2023657278\resources\views/quizzes/index.blade.php ENDPATH**/ ?>