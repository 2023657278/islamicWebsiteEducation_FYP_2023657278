...
<div class="container-fluid p-0 pb-5">
    ...
    <div class="mb-4 d-flex justify-content-between align-items-center text-start no-print">
        <div>
            ...
            <p class="text-muted small">Class: <span class="text-success fw-bold"><?php echo e($groupName); ?></span></p>
        </div>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $todayClasses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="today-class-item">
                    <div class="text-start">
                        <div class="fw-bold fs-5"><?php echo e($class->subject->subject_name); ?></div>
                        <small style="opacity: 0.8;"><?php echo e($class->teacher->name); ?></small>
                    </div>
                    <div class="fw-bold fs-4"><?php echo e(\Carbon\Carbon::parse($class->time_from)->format('H:i')); ?></div>
                </div>
    ...
    <div id="printableWeekly">
        ...
        <div class="print-only-header text-start">
            <div class="row">
                <div class="col-6">
                    ...
                    <p class="text-muted mb-0">Generated for: <strong><?php echo e(Auth::user()->name); ?></strong></p>
                </div>
                <div class="col-6 text-end">
                    <h5 class="fw-bold text-success mb-0">Class: <?php echo e($groupName); ?></h5>
                    <p class="text-muted mb-0">Academic Year: <?php echo e($currentYear); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="weekly-wrapper">
            <div class="timetable-grid">
                ...
                <?php $__currentLoopData = ['MON', 'TUE', 'WED', 'THU', 'FRI']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dayLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="grid-header"><?php echo e($dayLabel); ?></div>
                    ...
                    <?php $__currentLoopData = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="grid-cell">
                            ...
                            <?php if($class): ?>
                                ...
                                ?>
                                <div class="class-card <?php echo e($theme); ?>">
                                    <div style="font-weight: 800; font-size: 0.78rem;"><?php echo e($class->subject->subject_name); ?></div>
                                    <div style="font-size: 0.65rem; opacity: 0.8;"><?php echo e($class->teacher->name); ?></div>
                                </div>
                            <?php endif; ?>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('users.students', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\islamicWebsiteEducation_FYP_2023657278\resources\views/users/timetable/index.blade.php ENDPATH**/ ?>