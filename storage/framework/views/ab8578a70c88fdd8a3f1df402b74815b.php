...
<div class="container-fluid p-0 pb-5">
    ...
    <div class="row g-4 mb-5">
        <div class="col-md-4">
            <a href="<?php echo e(route('student.progress.index')); ?>" class="card border-0 shadow-sm rounded-4 text-decoration-none h-100 hover-scale">
        ...
        <div class="col-md-4">
            <a href="<?php echo e(route('student.timetable.view')); ?>" class="card border-0 shadow-sm rounded-4 text-decoration-none h-100 hover-scale">
                <div class="card-body p-4 d-flex align-items-center">
        ...
        <div class="col-md-4">
            <a href="<?php echo e(route('student.flashcards.index')); ?>" class="card border-0 shadow-sm rounded-4 text-decoration-none h-100 hover-scale">
                <div class="card-body p-4 d-flex align-items-center">
        ...
        <div class="col-md-4">
            <a href="<?php echo e(route('student.resources.index')); ?>" class="card border-0 shadow-sm rounded-4 text-decoration-none h-100 hover-scale">
                <div class="card-body p-4 d-flex align-items-center">
        ...
        <div class="col-md-4">
            <a href="<?php echo e(route('student.messages.index')); ?>" class="card border-0 shadow-sm rounded-4 text-decoration-none h-100 hover-scale">
                <div class="card-body p-4 d-flex align-items-center">
        ...
        <div class="col-md-4">
            <a href="<?php echo e(route('student.profile.show')); ?>" class="card border-0 shadow-sm rounded-4 text-decoration-none h-100 hover-scale">
                <div class="card-body p-4 d-flex align-items-center">
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-body p-4 text-start">
                    ...
                    <div class="mb-4">
                        <h1 class="fw-bold mb-0 text-dark" style="font-size: 3rem;"><?php echo e($totalQuizzes ?? 0); ?></h1>
                        <p class="text-muted">Quizzes Completed</p>
                    </div>
                    <div class="mb-4">
                        <div class="d-flex justify-content-between align-items-end mb-1">
                            <h2 class="fw-bold mb-0 text-dark"><?php echo e(round($averageScore ?? 0, 1)); ?>%</h2>
                            <small class="text-muted">Avg Score</small>
                        </div>
                        <div class="progress rounded-pill" style="height: 10px;">
                            <div class="progress-bar bg-success rounded-pill" role="progressbar" style="width: <?php echo e($averageScore ?? 0); ?>%"></div>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    new Chart(pieCtx, {
        type: 'pie',
        data: {
            labels: <?php echo json_encode(array_keys($subjectPerformance)); ?>,
            datasets: [{
                data: <?php echo json_encode(array_values($subjectPerformance)); ?>,
...
<?php echo $__env->make('users.students', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\islamicWebsiteEducation_FYP_2023657278\resources\views/users/dashboard.blade.php ENDPATH**/ ?>