...
<head>
    ...
    <title><?php echo e($quiz->title); ?> | Solo Mission</title>
...
<div class="container py-4" style="max-width: 950px;">
    <form action="<?php echo e(route('student.quizzes.submit', $quiz->id)); ?>" method="POST" id="quizForm">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="fw-black mb-0 text-white"><?php echo e($quiz->title); ?></h2>
                ...
                <div class="card border-0 shadow-lg overflow-hidden">
                    <div class="card-header bg-white border-bottom p-4">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span class="badge bg-light text-dark border">Task <?php echo e($index + 1); ?> / <?php echo e($quiz->questions->count()); ?></span>
                            <small class="text-muted fw-bold text-uppercase tracking-wider"><?php echo e(str_replace('_', ' ', $q->question_type)); ?></small>
                        </div>
                    ...
                    <div class="card-body p-4 bg-light bg-opacity-50">
                                ...
                                <div class="card-container" data-is-correct="<?php echo e($opt->is_correct); ?>" onclick="handleCardClick(this, '<?php echo e($q->question_type); ?>', <?php echo e($index + 1); ?>)">
                                    <div class="card-inner">
                                        <div class="card-front">
                                            <span class="fw-bold text-muted border rounded-circle d-flex align-items-center justify-content-center me-3 small" style="width:28px; height:28px;"><?php echo e(chr(65 + $optIndex)); ?></span>
                                            <span class="option-text"><?php echo e($opt->option_text); ?></span>
                                        </div>
                                        <div class="card-back">
                        ...
                        <?php elseif(in_array($q->question_type, ['text', 'fill_in_the_blank'])): ?>
                            <div class="card-container w-100" style="height: 120px;" id="text-card-<?php echo e($index + 1); ?>">
                                <div class="card-inner">
                                    <div class="card-front p-0 overflow-hidden">
                                        <textarea id="text-input-<?php echo e($q->id); ?>" class="form-control border-0 text-center fs-4 fw-bold h-100 bg-white" placeholder="Type answer here..." data-correct="<?php echo e($q->correct_answer_text); ?>"></textarea>
                                    ...
                                    <div class="card-back flex-column justify-content-center text-center">
                                        <h5 class="fw-black text-uppercase mb-0" id="fib-status-<?php echo e($index + 1); ?>">Verified</h5>
                                    </div>
                                </div>
                            </div>
                        <?php endif; ?>
...
</html><?php /**PATH C:\laragon\www\islamicWebsiteEducation_FYP_2023657278\resources\views/users/quizzes/take.blade.php ENDPATH**/ ?>