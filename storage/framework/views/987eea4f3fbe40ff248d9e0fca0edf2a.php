...
<div class="results-container">
    <div class="results-card">
        <div class="mb-4">
            ...
            <p class="text-muted">Room Code: <span class="text-primary fw-bold"><?php echo e($room->room_code); ?></span></p>
        </div>
        ...
        <div class="leaderboard-scroll">
            <?php $__currentLoopData = $participants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="rank-item <?php echo e($isWinner ? 'rank-1' : 'rank-' . $rank); ?>">
                    <div class="d-flex align-items-center">
                        <div class="rank-badge <?php echo e($isWinner ? 'bg-warning text-dark' : 'bg-primary text-white'); ?>">
                            <?php echo e($rank); ?>

                        </div>
                        <div class="text-start">
                            <div class="warrior-name">
                                <?php if($isWinner): ?> <i class="fas fa-crown crown-icon me-1"></i> <?php endif; ?>
                                <?php echo e(strtoupper($p->user->name)); ?>

                            </div>
                            <div class="small text-muted">
                                <i class="fas fa-heart text-danger me-1"></i> <?php echo e($p->hp); ?> HP Remaining
                            </div>
                        </div>
                    </div>

                    <div class="text-end">
                        <div class="status-pill <?php echo e($statusClass); ?> mb-1">
                        ...
                        <div class="small fw-bold text-info">
                            ...
                            ?>
                            <?php echo e($points > 0 ? '+' : ''); ?><?php echo e($points); ?> PTS
                        </div>
                    </div>
                </div>
        ...
        <div class="mt-5">
            <a href="<?php echo e(route('student.quizzes.index')); ?>" class="btn-home">
