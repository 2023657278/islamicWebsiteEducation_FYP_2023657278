...
<div class="container-fluid text-start">
    <?php if(session('success')): ?> <div class="alert alert-success border-0 shadow-sm mb-4"><?php echo e(session('success')); ?></div> <?php endif; ?>
    <?php if(session('error')): ?> <div class="alert alert-danger border-0 shadow-sm mb-4"><?php echo e(session('error')); ?></div> <?php endif; ?>
    ...
    <div class="profile-card shadow-sm">
        ...
        <div class="profile-content">
            ...
            <div class="d-flex justify-content-between align-items-end pt-3" style="padding-left: 130px;">
                <div>
                    <h2 class="fw-bold mb-1"><?php echo e($user->name); ?></h2>
                    <p class="text-muted mb-0">Form 4 Student • PAI Class</p>
                </div>
                <a href="<?php echo e(route('student.profile.edit')); ?>" class="btn btn-outline-secondary px-4 fw-bold" style="border-radius: 10px;">
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-md-3">
            <div class="info-box shadow-sm">
                ...
                <div><small class="text-muted d-block">Email</small><div class="fw-bold text-truncate" style="max-width: 150px;" title="<?php echo e($user->email); ?>"><?php echo e($user->email); ?></div></div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="info-box shadow-sm">
                ...
                <div><small class="text-muted d-block">Phone</small><div class="fw-bold"><?php echo e($user->phone_number ?? 'Not Set'); ?></div></div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="info-box shadow-sm">
                ...
                <div>
                    ...
                    <div class="fw-bold text-primary mb-0" style="font-size: 1.05rem;"><?php echo e($user->no_maktab ?? 'N/A'); ?></div>
                    <span class="text-muted" style="font-size: 0.72rem;">Joined: <?php echo e($user->created_at->format('M Y')); ?></span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-5">
        <div class="card-body p-4 d-flex align-items-center justify-content-between flex-wrap gap-3">
            ...
            <?php if($user->telegram_chat_id): ?>
                <form action="<?php echo e(route('telegram.unlink')); ?>" method="POST"><?php echo csrf_field(); ?><button type="submit" class="btn btn-outline-danger rounded-pill px-4 fw-bold">Disconnect Link</button></form>
            <?php else: ?>
    ...
    <div class="row g-4 mb-5">
        ...
        <div class="col-md-3">
            <div class="achieve-box unlocked shadow-sm">
                ...
                <div class="bg-light rounded p-2 text-sm font-weight-bold">
                    Record: <strong class="text-success"><?php echo e($achievements->highest_score); ?>%</strong>
                </div>
            </div>
        </div>

        
        <?php $quizProgressPercent = min(($achievements->total_quizzes / 5) * 100, 100); ?>
        <div class="col-md-3">
            <div class="achieve-box <?php echo e($achievements->total_quizzes >= 5 ? 'unlocked' : 'locked'); ?> shadow-sm">
                <span class="achieve-badge-status <?php echo e($achievements->total_quizzes >= 5 ? 'text-success' : 'text-muted'); ?>">
                    <i class="fas <?php echo e($achievements->total_quizzes >= 5 ? 'fa-lock-open' : 'fa-lock'); ?>"></i>
                </span>
                <div class="fs-1 mb-2" style="font-size: 2.8rem;">🔥</div>
                ...
                <div class="w-100 mt-2">
                    <div class="d-flex justify-content-between text-xs mb-1" style="font-size: 0.72rem;">
                        ...
                        <strong><?php echo e($achievements->total_quizzes); ?> / 5</strong>
                    </div>
                    <div class="achieve-progress-track">
                        <div class="progress-bar bg-success" style="width: <?php echo e($quizProgressPercent); ?>%; height: 100%;"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="achieve-box <?php echo e($achievements->perfect_scores >= 1 ? 'unlocked' : 'locked'); ?> shadow-sm">
                <span class="achieve-badge-status <?php echo e($achievements->perfect_scores >= 1 ? 'text-success' : 'text-muted'); ?>">
                    <i class="fas <?php echo e($achievements->perfect_scores >= 1 ? 'fa-lock-open' : 'fa-lock'); ?>"></i>
                </span>
                <div class="fs-1 mb-2" style="font-size: 2.8rem;">⭐</div>
                ...
                <div class="badge <?php echo e($achievements->perfect_scores >= 1 ? 'badge-success bg-success text-white' : 'badge-secondary bg-secondary text-white'); ?> px-3 py-1.5 rounded-pill">
                    <?php echo e($achievements->perfect_scores); ?> Unlocked Tier
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="achieve-box <?php echo e($achievements->telegram_status ? 'unlocked' : 'locked'); ?> shadow-sm">
                <span class="achieve-badge-status <?php echo e($achievements->telegram_status ? 'text-success' : 'text-muted'); ?>">
                    <i class="fas <?php echo e($achievements->telegram_status ? 'fa-lock-open' : 'fa-lock'); ?>"></i>
                </span>
                <div class="fs-1 mb-2" style="font-size: 2.8rem;">📱</div>
                ...
                <span class="text-xs font-weight-bold d-block mt-2 <?php echo e($achievements->telegram_status ? 'text-success' : 'text-muted'); ?>">
                    <i class="fas <?php echo e($achievements->telegram_status ? 'fa-check-circle' : 'fa-times-circle'); ?> mr-1"></i>
                    <?php echo e($achievements->telegram_status ? 'Gateway Linked' : 'Link Pending'); ?>
        ...
        <div class="modal-content rounded-4 border-0 p-4">
            ...
            <div class="modal-body text-center px-0">
                ...
                <div class="bg-light p-3 d-inline-block rounded-3 mb-4">
                    <h2 class="mb-0 fw-bold text-dark tracking-wider"><?php echo e($telegramCode ?? 'WAITING'); ?></h2>
                </div>
