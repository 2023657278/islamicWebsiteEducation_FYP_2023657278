...
<div class="container-fluid text-start">
    ...
    <div class="row g-4 mb-4">
        <div class="col-md-3">
            <div class="info-box shadow-sm">
                ...
                <div><small class="text-muted d-block">Email</small><div class="fw-bold text-truncate" style="max-width: 150px;"><?php echo e($user->email); ?></div></div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="info-box shadow-sm">
        ...
        <div class="col-md-3">
            <div class="info-box shadow-sm">
                ...
                <div><small class="text-muted d-block">Joined</small><div class="fw-bold"><?php echo e($user->created_at->format('F Y')); ?></div></div>
            </div>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-5">
        <div class="card-body p-4 d-flex align-items-center justify-content-between flex-wrap gap-3">
            ...
            <?php if($user->telegram_chat_id): ?>
                <form action="<?php echo e(route('telegram.unlink')); ?>" method="POST"><?php echo csrf_field(); ?><button type="submit" class="btn btn-outline-danger rounded-pill px-4 fw-bold">Disconnect</button></form>
            <?php else: ?>
    ...
    <div class="row g-4 mb-5">
        <div class="col-md-3">
            <div class="achieve-box unlocked shadow-sm">
                ...
                <small class="text-muted">Highest Score: <strong><?php echo e($achievements->highest_score); ?>%</strong></small>
            </div>
        </div>
        <div class="col-md-3">
            <div class="achieve-box <?php echo e($achievements->total_quizzes >= 5 ? 'unlocked' : 'locked'); ?> shadow-sm">
                ...
                <small class="text-muted"><?php echo e($achievements->total_quizzes); ?>/5 Quizzes Completed</small>
            </div>
        </div>
        <div class="col-md-3">
            <div class="achieve-box <?php echo e($achievements->perfect_scores >= 1 ? 'unlocked' : 'locked'); ?> shadow-sm">
                ...
                <small class="text-muted"><?php echo e($achievements->perfect_scores); ?> Perfect Scores</small>
            </div>
        </div>
        <div class="col-md-3">
            <div class="achieve-box <?php echo e($achievements->telegram_status ? 'unlocked' : 'locked'); ?> shadow-sm">
                ...
                <small class="text-muted"><?php echo e($achievements->telegram_status ? 'Telegram Linked' : 'Link Telegram'); ?></small>
            </div>
        </div>
    </div>
</div>
