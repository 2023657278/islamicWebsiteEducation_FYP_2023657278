...
<head>
    ...
    <title>Combat Arena | <?php echo e($room->room_code); ?></title>
        ...
        <div class="col-lg-8">
            <div class="battle-card shadow-2xl">
                <div class="d-flex justify-content-between align-items-end mb-5">
                    <div>
                        <h1 class="fw-black text-warning mb-0"><?php echo e(strtoupper(Auth::user()->name)); ?></h1>
                        <span class="text-muted small">LEVEL <?php echo e(strtoupper($room->quiz->difficulty)); ?> WARRIOR</span>
                    </div>
                    <div style="width: 350px;">
                        <div class="d-flex justify-content-between mb-1"><small class="fw-bold">HEALTH</small><small id="hpVal"><?php echo e($me->hp); ?>%</small></div>
                        <div class="hp-bar mb-3"><div id="myHp" class="hp-fill" style="width: <?php echo e($me->hp); ?>%"></div></div>
                    </div>
                </div>
            ...
            <div class="p-4 bg-slate-900 rounded-4 h-100 border border-slate-800">
                ...
                <div id="warriorList">
                    <?php $__currentLoopData = $room->participants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="mini-warrior" id="p-<?php echo e($p->user_id); ?>">
                            <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($p->user->name)); ?>&background=random" class="rounded-circle" width="45">
                            <div class="flex-grow-1">
                                <div class="small fw-bold d-flex justify-content-between">
                                    <span><?php echo e($p->user->name); ?></span>
                                    <span class="hp-text"><?php echo e($p->hp); ?>%</span>
                                </div>
                                <div class="hp-bar mt-1" style="height: 6px;"><div class="hp-fill" style="width: <?php echo e($p->hp); ?>%"></div></div>
                            </div>
                        </div>
...
<script>
    ...
    const quizData = <?php echo json_encode($room->quiz->questions, 15, 512) ?>;
    let currentIdx = -1;
        ...
        fetch(`/student/quizzes/pvp/${roomCode}/status`)
            ...
            .then(data => {
                ...
                data.participants.forEach(p => {
                    ...
                    if (p.user_id == <?php echo e(Auth::id()); ?>) {
    ...
    function triggerNextRound() {
        fetch(`/student/quizzes/pvp/${roomCode}/next`, { method: 'POST', headers: { 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' } });
    }
