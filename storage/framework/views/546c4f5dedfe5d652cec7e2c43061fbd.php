        ...
        <div class="col-md-3">
            <div class="card shadow-sm mb-4" style="border-top: 5px solid #800000;">
                <div class="card-body text-center">
                    ...
                    <h4 class="fw-bold"><?php echo e($teacher->name); ?></h4>
                    <p class="text-muted small"><?php echo e($teacher->email); ?></p>
                    <hr>
                    <div class="text-start">
                        <p class="small mb-2"><strong>Phone:</strong> <?php echo e($teacher->phone_number ?? 'N/A'); ?></p>
                        <p class="small mb-2"><strong>Role:</strong> Teacher</p>
                        <p class="small mb-0"><strong>Joined:</strong> <?php echo e($teacher->created_at->format('M Y')); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow-sm border-0 bg-dark text-white">
                <div class="card-body text-center">
                    ...
                    <h1 class="fw-bold text-warning mb-0"><?php echo e(round($overallTeacherRating, 1)); ?>%</h1>
                ...
                <div class="card-body">
                    ...
                    <div class="timetable-grid">
                        ...
                        <?php $__currentLoopData = $timeslots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $time): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="grid-header-time"><?php echo e($time); ?></div>
                        ...
                        <?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dayIndex => $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="day-label-cell"><?php echo e($shortDays[$dayIndex]); ?></div>
                            <?php $slotsToSkip = 0; ?>
                                    ...
                                    <?php if($currentLesson): ?>
                                        <div class="lesson-card">
                                            ...
                                            <div class="location-name">
                                                <i class="fas fa-users me-1"></i> <?php echo e($currentLesson->group->group_name); ?>
                                ...
                                <div class="card border-0 shadow-sm h-100">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            <h5 class="fw-bold mb-0 text-dark"><?php echo e($group->group_name); ?></h5>
                                            <span class="badge bg-<?php echo e($color); ?>"><?php echo e($group->performance_status); ?></span>
                                        </div>
                                        
                                        <div class="d-flex justify-content-between small text-muted mb-2">
                                            <span>Students: <?php echo e($group->students_count); ?></span>
                                            <span>Quizzes: <?php echo e($group->total_activity); ?></span>
                                        </div>

                                        <label class="small fw-bold mb-1">Average Score: <?php echo e($group->avg_performance); ?>%</label>
                                        <div class="progress" style="height: 10px;">
                                            <div class="progress-bar bg-<?php echo e($color); ?>" 
                                                 role="progressbar" 
                                                 style="width: <?php echo e($group->avg_performance); ?>%">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make(auth()->user()->role === 'admin' ? 'adminreal.master' : 'admin.adminhome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\islamicWebsiteEducation_FYP_2023657278\resources\views/teachers/show.blade.php ENDPATH**/ ?>