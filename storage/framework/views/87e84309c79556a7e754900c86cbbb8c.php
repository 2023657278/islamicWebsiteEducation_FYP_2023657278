...
<div class="container-fluid text-light">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-3 mb-3">
            <div class="card bg-dark h-100 border-secondary shadow-lg card-glow" style="border-left: 4px solid <?php echo e($card['color']); ?> !important; background-color: #121214 !important;">
                <div class="card-body p-3 d-flex flex-column justify-content-between">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div>
                            <p class="text-uppercase small font-weight-bold text-muted mb-1"><?php echo e($card['label']); ?></p>
                            <h1 class="font-weight-bold mb-0 text-white tracking-tight"><?php echo e($card['value']); ?></h1>
                        </div>
                        <div class="p-3 rounded" style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.05);">
                            <i class="fas <?php echo e($card['icon']); ?> fa-xl" style="color: <?php echo e($card['color']); ?>"></i>
                        </div>
                    </div>
                    <small class="text-xs text-muted-dark"><i class="fas fa-chart-line mr-1 text-secondary"></i> <?php echo e($card['desc']); ?></small>
                </div>
            </div>
        </div>
            ...
            <div class="card bg-dark border-secondary h-100 shadow" style="background-color: #121214 !important;">
                ...
                <div class="card-body d-flex flex-column justify-content-center">
                    ...
                    <div class="row text-center mt-3 text-xs">
                        <div class="col-6 text-primary"><i class="fas fa-circle mr-1"></i> Students (<?php echo e($ratios['student_percentage']); ?>%)</div>
                        <div class="col-6 text-success"><i class="fas fa-circle mr-1"></i> Teachers (<?php echo e($ratios['teacher_percentage']); ?>%)</div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="mb-4">
                        <div class="d-flex justify-content-between text-xs mb-1">
                            ...
                            <span class="text-warning font-weight-bold"><?php echo e($ratios['average_students_per_class']); ?> Users/Unit</span>
                        </div>
                        <div class="progress bg-black-opaque" style="height: 6px; background-color: #1a1a1e;">
                            <div class="progress-bar bg-warning progress-bar-striped" style="width: <?php echo e(min(($ratios['average_students_per_class']/40)*100, 100)); ?>%"></div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        <div class="d-flex justify-content-between text-xs mb-1">
                            ...
                            <span class="text-primary font-weight-bold"><?php echo e($systemMetrics['active_sessions']); ?> Online</span>
                        </div>
                        <div class="progress bg-black-opaque" style="height: 6px; background-color: #1a1a1e;">
                            <div class="progress-bar bg-primary" style="width: <?php echo e($stats['students'] > 0 ? ($systemMetrics['active_sessions'] / $stats['students']) * 100 : 0); ?>%"></div>
                        </div>
                    </div>
                    ...
                    <div class="mb-2">
                        <div class="d-flex justify-content-between text-xs mb-1">
                            ...
                            <span class="text-info font-weight-bold"><?php echo e($systemMetrics['telegram_linked']); ?> Connected</span>
                        </div>
                        <div class="progress bg-black-opaque" style="height: 6px; background-color: #1a1a1e;">
                            <div class="progress-bar bg-info" style="width: <?php echo e(($stats['students'] + $stats['teachers']) > 0 ? ($systemMetrics['telegram_linked'] / ($stats['students'] + $stats['teachers'])) * 100 : 0); ?>%"></div>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <table class="table table-dark table-hover table-borderless mb-0 text-xs text-muted-dark">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Dynamic Database Index active (Total records: <?php echo e($stats['students']); ?>)</td>
                                </tr>
                                <tr>
                                    <td>Telegram Webhook Gateway</td>
                                    <td><span class="text-info"><i class="fas fa-sync-alt fa-spin mr-1"></i> Listening</span></td>
                                    <td>Awaiting inbound handshakes (<?php echo e($systemMetrics['telegram_linked']); ?> accounts configured)</td>
                                </tr>
                                <tr>
                                    <td>Academic Resource Registry</td>
                                    <td><span class="text-success"><i class="fas fa-check-circle mr-1"></i> Unbounded</span></td>
                                    <td>Storage vector expanding smoothly (<?php echo e($stats['resources']); ?> files registered)</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    data: [<?php echo e($stats['students']); ?>, <?php echo e($stats['teachers']); ?>],
...
<?php echo $__env->make('adminreal.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\islamicWebsiteEducation_FYP_2023657278\resources\views/adminreal/dashboard.blade.php ENDPATH**/ ?>