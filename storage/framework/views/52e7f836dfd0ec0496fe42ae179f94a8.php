...
<div class="container text-center py-4" style="max-width: 800px;">
    ...
    <div class="d-flex justify-content-between align-items-center mb-5">
        ...
        <span class="badge bg-primary bg-opacity-10 text-primary fs-6 px-3 py-2 rounded-pill">
            <?php echo e($remaining); ?> Cards Remaining
        </span>
    </div>
    ...
    <div class="scene mx-auto" style="height: 400px; width: 100%;">
        <div class="flashcard" id="card" onclick="flipCard()">
            ...
            <div class="card-face card-back bg-light rounded-5 shadow-sm border d-flex flex-column align-items-center justify-content-center p-5">
                ...
                <h2 class="fw-bold text-success lh-base"><?php echo e($card->answer); ?></h2>
                <?php if($card->topic): ?>
                    <span class="badge bg-white text-dark border mt-4 px-3 py-2"><?php echo e($card->topic); ?></span>
                <?php endif; ?>
            </div>
    ...
    <div id="controls" class="mt-5" style="opacity: 0; pointer-events: none; transition: opacity 0.3s ease;">
        ...
        <form action="<?php echo e(route('student.flashcards.update')); ?>" method="POST" class="row g-2 justify-content-center">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('users.students', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\islamicWebsiteEducation_FYP_2023657278\resources\views/users/flashcards/study.blade.php ENDPATH**/ ?>