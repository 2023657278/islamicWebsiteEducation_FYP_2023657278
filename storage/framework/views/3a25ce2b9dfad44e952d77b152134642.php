...
<head>
    ...
    <title>Arena Lobby | <?php echo e($room->room_code); ?></title>
...
<div class="container d-flex justify-content-center">
    <div class="lobby-container">
        ...
        <div class="d-flex justify-content-center mb-4">
            <div class="room-badge shadow-lg"><?php echo e($room->room_code); ?></div>
        </div>
        
        <h2 class="fw-bold text-dark">Warriors Assembling: <span id="count" class="text-primary"><?php echo e($participants->count()); ?></span>/20</h2>
        ...
        <div class="arena-grid" id="warriorArena">
            ...
            <div class="warrior-card" data-user-id="<?php echo e($p->user_id); ?>">
                <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($p->user->name)); ?>&background=random&color=fff&size=128" 
                     class="rounded-circle mb-3 shadow-sm" width="80">
                <div class="small fw-bold text-truncate"><?php echo e($p->user->name); ?></div>
        ...
        <div class="mt-5 pt-4 border-top">
            ...
            <?php else: ?>
                <div class="py-3">
                    ...
                    <a href="<?php echo e(route('student.quizzes.index')); ?>" class="btn btn-outline-secondary rounded-pill px-4">
...
<script>
    ...
    const isHost = <?php echo e(Auth::id() === $room->host_id ? 'true' : 'false'); ?>;
    ...
    async function confirmDismiss() {
        if (confirm("ABORT MISSION: This will delete the lobby. Proceed?")) {
            ...
            if (res.ok) window.location.href = "<?php echo e(route('student.quizzes.index')); ?>";
        }
    }
        ...
        fetch(`/student/quizzes/lobby/${roomCode}/participants`)
            ...
            .then(data => {
                if (data.status === 'dismissed' || data.error) {
                    window.onbeforeunload = null;
                    window.location.href = "<?php echo e(route('student.quizzes.index')); ?>";
                    return;
                }
...
</html><?php /**PATH C:\laragon\www\islamicWebsiteEducation_FYP_2023657278\resources\views/users/quizzes/lobby.blade.php ENDPATH**/ ?>