    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body d-flex align-items-center">
                ...
                <div class="ml-auto">
                    <span class="h4 font-weight-bold text-dark"><?php echo e(\App\Models\User::where('role', 'student')->count()); ?></span>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body d-flex align-items-center">
                ...
                <div class="ml-auto">
                    <span class="h4 font-weight-bold text-dark"><?php echo e(\App\Models\Group::count()); ?></span>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body d-flex align-items-center">
                ...
                <div class="ml-auto">
                    <span class="h4 font-weight-bold text-dark"><?php echo e(\App\Models\Resources::count()); ?></span>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('admin.adminhome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\islamicWebsiteEducation_FYP_2023657278\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>