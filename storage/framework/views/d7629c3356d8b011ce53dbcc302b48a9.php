...
<head>
    ...
    <title><?php echo e($book->title); ?> - Reading Mode</title>
...
<body>
    ...
    <div class="top-bar">
        <div class="toolbar-group">
            <a href="<?php echo e(route('student.textbooks.index')); ?>" class="btn-icon" title="Exit"><i class="fas fa-times"></i></a>
            <button class="btn-icon" onclick="toggleSidebar()" title="Table of Contents"><i class="fas fa-list"></i></button>
            <span class="book-title ms-2"><?php echo e($book->title); ?></span>
        </div>
    ...
    <script>
        // --- CONFIGURATION ---
        const url = "<?php echo e(asset('storage/' . $book->file_url)); ?>";
        const resourceId = <?php echo e($book->id); ?>;
        let pdfDoc = null;
        let pageNum = <?php echo e($startPage); ?>;
        ...
        function saveProgress() {
            fetch("<?php echo e(route('student.textbooks.save_progress')); ?>", {
                method: "POST",
                headers: {
...
</html><?php /**PATH C:\laragon\www\islamicWebsiteEducation_FYP_2023657278\resources\views/users/resources/read.blade.php ENDPATH**/ ?>