    ...
    <div class="tab-content">
            ...
            <div class="tab-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-md-6 mb-4 resource-item group-<?php echo e($res->group_id); ?>">
                            <div class="card-wrapper shadow-sm">
                                ...
                                <div class="class-footer-tag"><small class="font-weight-bold text-muted"><i class="fas fa-users mr-1"></i> <?php echo e($res->group->group_name ?? 'Unassigned'); ?> (<?php echo e($res->group->year->year ?? 'N/A'); ?>)</small></div>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?> <div class="col-12 text-center py-5">No notes found.</div> <?php endif; ?>
                    </div>
                </div>
                <div class="tab-pane fade" id="sub-videos">
                    <div class="row">
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?> <div class="col-12 text-center py-5">No videos found.</div> <?php endif; ?>
                    </div>
                </div>
            </div>
        </div>
        <div class="tab-pane fade" id="content-textbooks">
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6 mb-4"><?php echo $__env->make('resources.partials.resource-card', ['res' => $res], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?></div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?> <div class="col-12 text-center py-5">No textbooks.</div> <?php endif; ?>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="modal-body p-4 bg-light">
                <form action="<?php echo e(route('resources.store')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3"><label>Subject</label><select name="subject_id" class="form-control" required><?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <option value="<?php echo e($s->id); ?>"><?php echo e($s->subject_name); ?></option> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select></div>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0">
            ...
            <div class="modal-body p-4">
                <form action="<?php echo e(route('resources.sync.auth')); ?>" method="GET">
