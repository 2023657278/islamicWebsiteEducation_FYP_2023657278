    ...
    <div class="p-4 bg-white shadow-sm rounded-lg border-left border-danger mb-4">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                ...
                <p class="text-muted mb-0">Class: <strong><?php echo e(\App\Models\Group::find($group_id)?->group_name ?? 'General Resource'); ?></strong></p>
            </div>
            <a href="<?php echo e(route('resources.index')); ?>" class="btn btn-light btn-sm rounded-pill px-4 border font-weight-bold">
                ...
                <div class="col-md-7">
                    <div class="input-group shadow-sm rounded-pill overflow-hidden border">
                        <input type="text" id="searchTerm" class="form-control border-0 px-4" style="height: 50px;" 
                               placeholder="Search for lessons (e.g. 'Tarawih', 'Puasa')..." value="<?php echo e($query ?? ''); ?>">
...
<script>
    let nextPageToken = '';
    let currentType = "<?php echo e($type ?? 'public'); ?>"; 
    let currentQuery = '';
        ...
        try {
            ...
            if (res.status === 401) {
                if(confirm("To see your channel's videos, you need to sync your account. Sync now?")) {
                    window.location.href = "<?php echo e(route('resources.sync.auth')); ?>";
                }
