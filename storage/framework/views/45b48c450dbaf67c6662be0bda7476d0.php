...
<body>
    ...
    <section id="textbooks">
        <div class="container">
                ...
                <div class="col-md-4 col-lg-2" data-aos="flip-left" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                    <div class="textbook-card shadow-sm">
                        ...
                        <div class="textbook-body">
                            <h6 class="fw-bold text-dark text-truncate mb-0" style="font-size: 0.85rem;"><?php echo e($subject->subject_name); ?></h6>
                        </div>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="text-center mt-5">
                <a href="<?php echo e(route('student.textbooks.index')); ?>" class="btn-primary-custom px-5 py-3 shadow-lg">Start Reading</a>
            </div>
        </div>
    </section>
    ...
    <footer class="text-center">
        <div class="container border-top pt-4">
            <p class="small">© <?php echo e(date('Y')); ?> PAI Learning Platform. All Rights Reserved.</p>
        </div>
    </footer>
